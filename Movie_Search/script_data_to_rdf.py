...
#____________________ generate country________________ identities (done) -
"""
...
print (final2)
"""
#____________________generate corporate identities________________ (done) -
"""
...
print (final2)
"""
#____________________generating gender identities________________ (done) -
...
#_____________________________________________generating human individuals
"""
...
for x in humans:
    ...
    #type actor or producer or writer
    ...
    final = string_comment + string_id + string_type_person + string_types + string_knownFor + string_birthYear + string_deathYear + string_name + string_sex + string_close
    print (final)


#____________________________managing individuals movies_____________________________
...
for key in movies:
    ...
    final = s_comment + s_abre + s_type + s_country + s_studio + s_genre + s_language + s_mpaa + s_ator + s_writer + s_drtr + s_name + s_votes + s_plot + s_poster + s_year + s_rating + s_runtime + s_fec
    print (final)
